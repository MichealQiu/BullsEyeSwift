...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let trackRightImage = UIImage(named: "SliderTrackRight") {
            let tarckRightResizable = trackRightImage.resizableImageWithCapInsets(insets)
            slider.setMaximumTrackImage(tarckRightResizable, forState: UIControlState.Normal)
        }
